...
public record PartnerManagerLoginCommand(string Email, string Password) : LoginCommand(Email, Password), IRequest<(AdminAuthResponse<PartnerManagerRepresentation> Response, string RefreshToken)>;

public class PartnerManagerLoginCommandHandler(
    UserManager<User> userManager,
    ITokenService tokenService) :
    IRequestHandler<PartnerManagerLoginCommand, (AdminAuthResponse<PartnerManagerRepresentation> Response, string RefreshToken)>
{
