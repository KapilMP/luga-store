...
public record GetPartnerManagersQuery(int PartnerId, int PageNumber, int PageSize, bool? Invited, bool? IsActive) : IRequest<PaginatedList<PartnerManagerRepresentation>>;

public class GetPartnerManagersHandler(IApplicationDbContext dbContext) : IRequestHandler<GetPartnerManagersQuery, PaginatedList<PartnerManagerRepresentation>>
{
