...
public record CustomerLoginCommand(string Email, string Password) : LoginCommand(Email, Password), ICommand<(AdminAuthResponse<CustomerRepresentation> Response, string RefreshToken)>;
