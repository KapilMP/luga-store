...
public class BaseUserProfile
{
    ...
    protected static T MapBase<T>(User user, T dto) where T : BaseUserProfile
    {
        ...
        dto.AvatarFileName = user.AvatarFileName ?? string.Empty;
...
public class OwnerProfileDto : BaseUserProfile
{
    public static OwnerProfileDto From(User user) => MapBase(user, new OwnerProfileDto());
}

public class ManagerProfileDto : BaseUserProfile
{
    public static ManagerProfileDto From(User user) => MapBase(user, new ManagerProfileDto());
}
