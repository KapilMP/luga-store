    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopManagers", x => new { x.ShopId, x.ManagerId });
                    table.ForeignKey(
                        name: "FK_ShopManagers_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopOwners", x => new { x.ShopId, x.OwnerId });
                    table.ForeignKey(
                        name: "FK_ShopOwners_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ShopId_Slug",
                table: "Categories",
