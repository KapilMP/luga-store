...
namespace LugaStore.Application.Emails.Queries;
...
public class GetEmailLogsQueryHandler(IApplicationDbContext dbContext) : IRequestHandler<GetEmailLogsQuery, EmailLogsDto>
{
